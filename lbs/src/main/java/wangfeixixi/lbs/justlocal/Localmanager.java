...
public class Localmanager {
    ...
    public boolean isSartLocation = false;
     ...
     * 初始化定位
     */
    public void initLocation(Context context, final OnLocationListener listener) {
        //初始化client
        ...
        locationClient.setLocationListener(new AMapLocationListener() {
            ...
            public void onLocationChanged(AMapLocation aMapLocation) {
                ...
                locationInfo.localtionType = aMapLocation.getLocationType();
                ...
                locationInfo.satellites = aMapLocation.getSatellites();
                ...
                locationInfo.time = aMapLocation.getTime();
                //失败信息
                ...
                //状态
                locationInfo.wifiEnable = aMapLocation.getLocationQualityReport().isWifiAble();
                locationInfo.gpsStatus = aMapLocation.getLocationQualityReport().getGPSStatus();
                locationInfo.gpsSatelites = aMapLocation.getLocationQualityReport().getGPSSatellites();
...
//                tvResult.setText("定位失败，loc is null");
    ...
    //配置信息
    private boolean cbOnceLocation = false;//单词定位
    private boolean cbAddress = true;//逆地理编码
    private boolean cbGpsFirst = true;//gps有限
    private boolean cbCacheAble = true;//开启缓存
    private boolean cbOnceLastest = false;//提高首次定位精度
    private boolean cbSensorAble = false;//使用传感器
    private int interval = 1000;//定位周期ms   // 设置发送定位请求的时间间隔,最小值为1000，如果小于1000，按照1000算
    private int netTimeout = 30000;//网络超时时间
    ...
    private void resetOption() {
        ...
        // 设置网络请求超时时间
        locationOption.setHttpTimeOut(netTimeout);
    }
}
