        ...
        RxBus.getInstance().chainProcess(new Func1() {
            ...
            public Object call(Object o) {
                ...
                request.setBody("latitude",
                        new Double(locationInfo.latitude).toString());
                request.setBody("longitude",
                        new Double(locationInfo.longitude).toString());
                request.setBody("key", locationInfo.key);
                request.setBody("rotation",
                        new Float(locationInfo.rotation).toString());
        ...
        RxBus.getInstance().chainProcess(new Func1() {
            ...
            public Object call(Object o) {
                ...
                request.setBody("startLatitude",
                        new Double(startLocation.latitude).toString());
                request.setBody("startLongitude",
                        new Double(startLocation.longitude).toString());
                request.setBody("endLatitude",
                        new Double(endLocation.latitude).toString());
                request.setBody("endLongitude",
                        new Double(endLocation.longitude).toString());
